...
DescriptionModalItem::DescriptionModalItem(ElementContainer* parent, const char* title, const char* description) : CustomElement(parent, 80, 10), title(title), description(description){
}
